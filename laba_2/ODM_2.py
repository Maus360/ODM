...
# Математическая разность множеств B и A
def difference_b_a():
	...
	for i in b:
		...
		if i in a:
			## Удаляем выбранный элемент множества A из множества F
			F.remove(i)
			# Выбираем следующий элемент множества F
	# Выводим на экран результат операции математической разности множеств B и A (множество F).
	return set(F)

# Математическая разность множеств A и B
def difference_a_b():
	# Создается пустое множество E
	E=[]
	# Копируем каждый элемент множества A в множество E
	E = list(a)
	...
	for i in a:
		...
		if i in b:
			...
			E.remove(i)
			# Выбираем следующий элемент множества E
...
# Декартовое произведение множеств А и В
def dek(a, b):
...
def union(A, B):
	...
	for i in B:
		...
		if i not in C:
			...
			C.append(i)
			# Выбираем следующий элемент множества C.
		#Выбираем следующий элемент множества В.
