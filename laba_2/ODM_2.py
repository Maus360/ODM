...
if i == "2":
	...
	# Вводим мощность m1 множества A.
	m1 = int(input("Введите мощность множества A\nm1="))
	...
	# Вводим мощность m2 множества B.
	m2 = int(input("Введите мощность множества B\nm2="))
...
def laba():
	print('1. Объединение A и B: C =', union())
	print('2. Пересечение A и B: D =', intersection())
	print('3. Рaзность A и B: E =', difference_a_b())
	print('4. Рaзность B и A: F =', difference_b_a())
	print('5. Симметричнaя рaзность A и B: G =', sim_diff())
